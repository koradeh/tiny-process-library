...
int main() {
  ...
  Process process1a("echo Hello World", "", [](const char* bytes, size_t n) {
    cout << "Output from stdout: "
            "\033[1;33m"
         << string(bytes, n) << "\033[0m";
  });
  auto exit_status = process1a.get_exit_status();
  cout << "Example 1a process returned: " << exit_status << " ("
       << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  this_thread::sleep_for(chrono::seconds(2));

  cout << endl << "Example 1b - Hello World using arguments" << endl;
  Process process1b(vector<string>{"/bin/ping", "google.com"}, "",
  ...
  cout << "Example 1b process returned: " << exit_status << " ("
       << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  this_thread::sleep_for(chrono::seconds(2));

#ifndef _WIN32
  cout << endl
       << "Example 1c - Hello World through a function on Unix-like systems"
       << endl;
  Process process1c(
      [] {
  ...
  cout << "Example 1c process returned: " << exit_status << " ("
       << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  this_thread::sleep_for(chrono::seconds(2));
#endif
  ...
  cout << "Example 2 process returned: " << exit_status << " ("
       << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  this_thread::sleep_for(chrono::seconds(2));
  ...
  thread thread3([]() {
    ...
    cout << "Example 3 process returned: " << exit_status << " ("
         << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  });
  thread3.detach();
  ...
  thread thread4([process4]() {
    ...
    cout << "Example 4 process returned: " << exit_status << " ("
         << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  });
  thread4.detach();
  this_thread::sleep_for(chrono::seconds(2));
  ...
  cout << "Example 5 process returned: " << exit_status << " ("
       << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  this_thread::sleep_for(chrono::seconds(2));
  ...
  cout << "Example 6 process returned: " << exit_status << " ("
       << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  this_thread::sleep_for(chrono::seconds(2));
  ...
  this_thread::sleep_for(chrono::seconds(2));
  process7.write("How are u?\n");
  this_thread::sleep_for(chrono::seconds(2));
  process7.close_stdin();
  exit_status = process7.get_exit_status();
  cout << "Example 7 process returned: " << exit_status << " ("
       << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  this_thread::sleep_for(chrono::seconds(2));
  ...
  cout << "Example 8 process returned: " << exit_status << " ("
       << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  this_thread::sleep_for(chrono::seconds(2));

  cout << endl << "Example 9 - launch with different environment" << endl;
  Process process9("printenv", "",
                   {{"VAR1", "value1"}, {"VAR2", "second value"}},
                   [](const char* bytes, size_t n) {
                     std::cout << "\033[1;33m" << string(bytes, n) << "\033[0m";
                   });
  exit_status = process9.get_exit_status();
  cout << "Example 9 process returned: " << exit_status << " ("
       << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  this_thread::sleep_for(chrono::seconds(2));
  ...
  cout << "Example 10 process returned: " << exit_status << " ("
       << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  ...
  Process process1("cmd /C echo Hello World", "",
                   [](const char* bytes, size_t n) {
                     cout << "Output from stdout: " << string(bytes, n);
                   });
  auto exit_status = process1.get_exit_status();
  cout << "Example 1 process returned: " << exit_status << " ("
       << (exit_status == 0 ? "success" : "failure") << ")" << endl;
  this_thread::sleep_for(chrono::seconds(2));
